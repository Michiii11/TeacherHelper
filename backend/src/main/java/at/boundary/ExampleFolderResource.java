...
import at.repository.ExampleFolderRepository;
...
public class ExampleFolderResource {

    @Inject
    ExampleFolderRepository repo;

    @GET
    @Path("/school/{schoolId}")
    public List<ExampleFolderDTO> getFolders(@PathParam("schoolId") Long schoolId,
    ...
    @POST
    @Path("/school/{schoolId}")
    public Response createFolder(@PathParam("schoolId") Long schoolId, CreateExampleFolderDTO dto) {
        return repo.createFolder(schoolId, dto);
    }

    @PUT
    @Path("/{folderId}")
    public Response updateFolder(@PathParam("folderId") String folderId, UpdateExampleFolderDTO dto) {
